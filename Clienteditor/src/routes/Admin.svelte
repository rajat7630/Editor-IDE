<script>
  ...
  let problemtest = {
    testcase: pb_testcase,
    output: pb_output
  };

  let adminEmail = "adarsh.kumar@sourcefuse.com";
  async function addProblem() {
    try {
      await mutate(client, {
        mutation: { mutation: apolloClient.addProblem },
        variables: {
          pb_name,
          pb_statement,
          problemtest,
...
<!--Modal-->
<div
  class="modalt opacity-0 pointer-events-none fixed w-full h-full top-0 left-0
  flex items-center justify-center">
  <div class="modal-overlayt absolute w-full h-full bg-gray-900 opacity-50" />
  ...
  <div
    ...
    <div
      class="modal-closet absolute top-0 right-0 cursor-pointer flex flex-col
    ...
    <div class="modal-content py-4 text-left px-6">
      ...
      <!--Body-->
      <form class="w-full max-w-md" on:submit={addProblem}>
